...
class TestCore:
    ...
    def mock_format_message(self, data, *args, **kwargs):
        message = f"Très bonne question, l'adresse est ici : {data['address']}. \n" \
                  f"Oh mais il y a ce lieu à ne pas manquer à deux pas de là.  \n" \
...
parser_return = {'error': False,
                 'input_raw': "Bonsoir Grandpy, j'espère que tu as passé une belle semaine. Est-ce que tu pourrais m'indiquer l'adresse de la tour eiffel ? Merci d'avance et salutations à Mamie.",
                 ...
                 'lat': 43.1, 'lon': 6.3, 'address': '', 'pageid': None, 'page_id_article': None, 'url': ''}
google_req_return = {'error': False,
                     'input_raw': "Bonsoir Grandpy, j'espère que tu as passé une belle semaine. Est-ce que tu pourrais m'indiquer l'adresse de la tour eiffel ? Merci d'avance et salutations à Mamie.",
                     'input_loc': 'tour eiffel', 'formatted_message': '',
                     'no_result': "Désolé, je n'ai pas compris ta demande ou je ne connais pas ce lieu. Try again !",
                     'lat': 48.85837009999999, 'lon': 2.2944813,
                     'address': 'Champ de Mars, 5 Avenue Anatole France, 75007 Paris, France', 'pageid': None,
...
wiki_req_return = {'error': False,
                   ...
                   'no_result': "Désolé, je n'ai pas compris ta demande ou je ne connais pas ce lieu. Try again !",
                   'lat': 48.85837009999999, 'lon': 2.2944813,
                   'address': 'Champ de Mars, 5 Avenue Anatole France, 75007 Paris, France', 'pageid': 5422039,
                   'page_id_article': "L'allée Paul-Deschanel est une voie du 7e arrondissement de Paris, en France.\n\n\nSituation et accès\nL'allée Paul-Deschanel est une voie publique située dans le 7e arrondissement de Paris. Elle débute au 67, quai Branly et se termine avenue Silvestre-de-Sacy.",
                   'url': 'https://fr.wikipedia.org/wiki/All%C3%A9e_Paul-Deschanel'}
_format_message_return = {'error': False,
                          'input_raw': "Bonsoir Grandpy, j'espère que tu as passé une belle semaine. Est-ce que tu pourrais m'indiquer l'adresse de la tour eiffel ? Merci d'avance et salutations à Mamie.",
                          'input_loc': 'tour eiffel',
                          'formatted_message': "Très bonne question, l'adresse est ici : Champ de Mars, 5 Avenue Anatole France, 75007 Paris, France. \nOh mais il y a ce lieu à ne pas manquer à deux pas de là.  \nL'allée Paul-Deschanel est une voie du 7e arrondissement de Paris, en France.\n\n\nSituation et accès\nL'allée Paul-Deschanel est une voie publique située dans le 7e arrondissement de Paris. Elle débute au 67, quai Branly et se termine avenue Silvestre-de-Sacy.. \nPour en savoir plus visite ce lien :) \nhttps://fr.wikipedia.org/wiki/All%C3%A9e_Paul-Deschanel",
                          'no_result': "Désolé, je n'ai pas compris ta demande ou je ne connais pas ce lieu. Try again !",
                          'lat': 48.85837009999999, 'lon': 2.2944813,
                          'address': 'Champ de Mars, 5 Avenue Anatole France, 75007 Paris, France', 'pageid': 5422039,
                          'page_id_article': "L'allée Paul-Deschanel est une voie du 7e arrondissement de Paris, en France.\n\n\nSituation et accès\nL'allée Paul-Deschanel est une voie publique située dans le 7e arrondissement de Paris. Elle débute au 67, quai Branly et se termine avenue Silvestre-de-Sacy.",
